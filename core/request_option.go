...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.RoamVersion != nil {
		header.Set("Roam-Version", fmt.Sprintf("%v", *r.RoamVersion))
	}
	return header
}
...
// RoamVersionOption implements the RequestOption interface.
type RoamVersionOption struct {
	RoamVersion *string
}

func (r *RoamVersionOption) applyRequestOptions(opts *RequestOptions) {
	opts.RoamVersion = r.RoamVersion
}

...
// WithRoamVersion sets the roamVersion request header.
//
// Dated API version pin (`YYYY-MM-DD`), e.g. `2026-07-23`. When omitted,
// the server uses the version stamped on the API key / OAuth app / PAT at
// creation. Send this to try a different revision without changing the pin.
// See https://developer.ro.am/docs/guides/api-versioning
func WithRoamVersion(roamVersion *string) *core.RoamVersionOption {
	return &core.RoamVersionOption{
		RoamVersion: roamVersion,
	}
}

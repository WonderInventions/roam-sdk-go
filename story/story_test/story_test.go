...
func TestStoryPostWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Story.Post(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestStoryPostWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestStoryPostWithWireMock", "POST", "/story.post", nil, 1)
}
